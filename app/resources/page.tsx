...
export const metadata: Metadata = {
  title: "Resources | Gen Fulton Consultancy",
  description:
    "Explore Gen Fulton's stress management course for high performers and her podcast on overcoming perfectionism using Somatic Experiencing, CBT, and mindfulness.",
  openGraph: {
    title: "Resources | Gen Fulton Consultancy",
    description:
      "Explore Gen Fulton's stress management course for high performers and her podcast on overcoming perfectionism using Somatic Experiencing, CBT, and mindfulness.",
...
const RESOURCES = [
  {
    ...
    imageAlt: "Stress management and performance course for golfers and high performers",
    button: "View Course",
  ...
  return (
    <>
      <section className={styles.resources}>
        <BlobLayer />
        <h1>Coaching & Therapy Resources</h1>
          ...
          {RESOURCES.map((item, index) => (
            <div key={index} className={styles.singleResourcesContainer}>
              ...
              <div className={styles.textButtonContainer}>
                ...
                {item.audioSrc ? (
                  <AudioPlayerToggle audioSrc={item.audioSrc} buttonLabel={item.button} />
                ) : (
